      ...
      <div className="flex flex-row gap-[20px] 2xl:max-w-screen-xxl xl:max-w-screen-xl lg:max-w-screen-lg w-screen">
        <div className="flex flex-col gap-[20px] w-[75%]">
          <div className="flex gap-[20px] justify-between h-[400px]">
            <PlayerCard data={playerInfo} page={"user"} />
            <WinDrawLossChart data={winDrawLoss} page={"user"} />
            <RadialChart data={avgRating} page={"user"} />
          </div>
          <div className="flex gap-[20px] justify-between h-[400px]">
            <PlayStyle data={playstyle} page={"user"} />
            <LineChart data={recentGames} page={"user"} />
          </div>
          <div className="flex gap-[20px] justify-between h-[400px]">
            <Heatmap />
          </div>
        </div>
        <PlayerStats data={statValues} page={"user"} />
      </div>
    </div>
  );
};
